...
public class ProjectDAOImpl implements ProjectDAO {
    ...
    public Long addNewProject(Project project) {
        ...
        SqlParameterSource ps = new MapSqlParameterSource()
                ...
                .addValue("c_created_at", project.getCreatedAt())
                .addValue("c_updated_at", project.getUpdatedAt());

        KeyHolder keyHolder = new GeneratedKeyHolder();

        Long returnValue = (long)namedParameterJdbcTemplate.update(ADD_PROJECT, ps, keyHolder,new String[]{"id"});
    ...
    public String updateProject(Project newProject) {
        SqlParameterSource ps = new MapSqlParameterSource()
                ...
                .addValue("c_created_at", newProject.getCreatedAt())
                .addValue("c_updated_at", newProject.getUpdatedAt());
    ...
    public static class ProjectRowMapper implements RowMapper<Project> {
        ...
        public Project mapRow(ResultSet resultSet, int rowNumber) throws SQLException {
            ...
            project.setCreatedAt(resultSet.getTimestamp("c_created_at"));
            project.setUpdatedAt(resultSet.getDate("c_updated_at"));
            return project;
        }
    }
